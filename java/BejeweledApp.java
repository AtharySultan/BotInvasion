    ...
    private void checkCombo(List<Jewel> jewelsLine) {
        ...
        if(count == 0) {
            ...
            if (score.get() == 1000) {
                ...
                alert.setHeaderText("Congratulations, you found the first number in the code.");
                alert.setContentText("You won!");
                ImageView imageView = new ImageView("66.gif");
                ...
                alert.showAndWait();
                // إذا حقق اللاعب 1000 نقطة، قم بإيقاف اللعبة
            }
